...
static struct msm_platform_core_capability core_data_kera_v0[] = {
	/* {type, value} */
...
static struct msm_platform_core_capability core_data_kera_v1[] = {
	/* {type, value} */
	{ENC_CODECS, H264 | HEVC | HEIC},
	{DEC_CODECS, H264 | HEVC | VP9 | AV1 | HEIC},
	{MAX_SESSION_COUNT, 16},
...
static struct msm_platform_inst_capability instance_cap_data_kera_v0[] = {
	/* {cap, domain, codec,
...
static struct msm_platform_inst_capability instance_cap_data_kera_v1[] = {
	/* {cap, domain, codec,
	 *      min, max, step_or_mask, value,
	 *      v4l2_id,
	 *      hfi_id,
...
static const struct bw_table kera_bw_table[] = {
...
static const struct clk_table kera_clk_table[] = {
...
static const struct clk_rst_table kera_clk_reset_table[] = {
	{ "video_axi_reset",        0  },
	{ "video_xo_reset",         1  },
	{ "video_mvs0c_reset",      0  },
	{ "video_mvs0_reset",       0  },
...
/* name, llcc_id */
static const struct subcache_table kera_subcache_table[] = {
	{ "vidsc0",     LLCC_VIDSC0 },
};

/* name, start, size, secure, dma_coherant, region, dma_mask */
const struct context_bank_table kera_context_bank_table[] = {
	{"qcom,vidc,cb-ns",
...
/* freq */
static struct freq_table kera_freq_table_sku0[] = {
	{533333333}, {444000000}, {366000000}, {338000000}, {240000000}, {192000000}
};

static struct freq_table kera_freq_table_sku1[] = {
...
static const struct device_region_table kera_device_region_table[] = {
	{
		"aon-registers",
...
/* decoder properties */
static const u32 kera_vdec_psc_avc[] = {
	HFI_PROP_BITSTREAM_RESOLUTION,
	HFI_PROP_CROP_OFFSETS,
	HFI_PROP_CODED_FRAMES,
	HFI_PROP_BUFFER_FW_MIN_OUTPUT_COUNT,
...
static const u32 kera_vdec_psc_hevc[] = {
	HFI_PROP_BITSTREAM_RESOLUTION,
	HFI_PROP_CROP_OFFSETS,
	HFI_PROP_LUMA_CHROMA_BIT_DEPTH,
	HFI_PROP_BUFFER_FW_MIN_OUTPUT_COUNT,
...
static const u32 kera_vdec_psc_vp9[] = {
	HFI_PROP_BITSTREAM_RESOLUTION,
	HFI_PROP_CROP_OFFSETS,
	HFI_PROP_LUMA_CHROMA_BIT_DEPTH,
	HFI_PROP_BUFFER_FW_MIN_OUTPUT_COUNT,
...
static const u32 kera_vdec_psc_av1[] = {
	HFI_PROP_BITSTREAM_RESOLUTION,
	HFI_PROP_CROP_OFFSETS,
	HFI_PROP_LUMA_CHROMA_BIT_DEPTH,
	HFI_PROP_BUFFER_FW_MIN_OUTPUT_COUNT,
...
static const u32 kera_vdec_input_properties_avc[] = {
	HFI_PROP_NO_OUTPUT,
	HFI_PROP_SUBFRAME_INPUT,
	HFI_PROP_DPB_LIST,
};

static const u32 kera_vdec_input_properties_hevc[] = {
	HFI_PROP_NO_OUTPUT,
	HFI_PROP_SUBFRAME_INPUT,
	HFI_PROP_DPB_LIST,
};

static const u32 kera_vdec_input_properties_vp9[] = {
	HFI_PROP_NO_OUTPUT,
	HFI_PROP_SUBFRAME_INPUT,
	HFI_PROP_DPB_LIST,
};

static const u32 kera_vdec_input_properties_av1[] = {
	HFI_PROP_NO_OUTPUT,
	HFI_PROP_SUBFRAME_INPUT,
	HFI_PROP_DPB_LIST,
...
static const u32 kera_vdec_output_properties_avc[] = {
...
static const u32 kera_vdec_output_properties_hevc[] = {
	HFI_PROP_WORST_COMPRESSION_RATIO,
	HFI_PROP_WORST_COMPLEXITY_FACTOR,
	HFI_PROP_PICTURE_TYPE,
	HFI_PROP_FENCE,
...
static const u32 kera_vdec_output_properties_vp9[] = {
	HFI_PROP_WORST_COMPRESSION_RATIO,
	HFI_PROP_WORST_COMPLEXITY_FACTOR,
	HFI_PROP_PICTURE_TYPE,
	HFI_PROP_FENCE,
...
static const u32 kera_vdec_output_properties_av1[] = {
	HFI_PROP_WORST_COMPRESSION_RATIO,
	HFI_PROP_WORST_COMPLEXITY_FACTOR,
	HFI_PROP_PICTURE_TYPE,
	HFI_PROP_FENCE,
...
static const u32 kera_msm_vidc_ssr_type[] = {
...
static struct msm_vidc_efuse_data efuse_data_kera[] = {
	/* IRIS_FMAX_LIMIT_UHD60, SKU VERSION: 1 */
	EFUSE_ENTRY(0x221C8114, 4, 0x20000000, 0x1D, SKU_VERSION),
};

static const struct msm_vidc_platform_data kera_data_v0 = {
	...
	.clk_rst_tbl_size = ARRAY_SIZE(kera_clk_reset_table),
	.subcache_tbl = kera_subcache_table,
	.subcache_tbl_size = ARRAY_SIZE(kera_subcache_table),

	/* populate context bank */
	.context_bank_tbl = kera_context_bank_table,
	.context_bank_tbl_size = ARRAY_SIZE(kera_context_bank_table),

	/* platform specific resources */
	.freq_tbl = kera_freq_table_sku0,
	.freq_tbl_size = ARRAY_SIZE(kera_freq_table_sku0),
	.reg_prst_tbl = kera_reg_preset_table,
	...
	.core_data = core_data_kera_v0,
	.core_data_size = ARRAY_SIZE(core_data_kera_v0),
	.inst_cap_data = instance_cap_data_kera_v0,
	.inst_cap_data_size = ARRAY_SIZE(instance_cap_data_kera_v0),
	...
	.psc_avc_tbl = kera_vdec_psc_avc,
	.psc_avc_tbl_size = ARRAY_SIZE(kera_vdec_psc_avc),
	.psc_hevc_tbl = kera_vdec_psc_hevc,
	.psc_hevc_tbl_size = ARRAY_SIZE(kera_vdec_psc_hevc),
	.psc_vp9_tbl = kera_vdec_psc_vp9,
	.psc_vp9_tbl_size = ARRAY_SIZE(kera_vdec_psc_vp9),
	.psc_av1_tbl = kera_vdec_psc_av1,
	.psc_av1_tbl_size = ARRAY_SIZE(kera_vdec_psc_av1),
	.dec_input_prop_avc = kera_vdec_input_properties_avc,
	.dec_input_prop_hevc = kera_vdec_input_properties_hevc,
	.dec_input_prop_vp9 = kera_vdec_input_properties_vp9,
	.dec_input_prop_av1 = kera_vdec_input_properties_av1,
	.dec_input_prop_size_avc = ARRAY_SIZE(kera_vdec_input_properties_avc),
	.dec_input_prop_size_hevc = ARRAY_SIZE(kera_vdec_input_properties_hevc),
	.dec_input_prop_size_vp9 = ARRAY_SIZE(kera_vdec_input_properties_vp9),
	.dec_input_prop_size_av1 = ARRAY_SIZE(kera_vdec_input_properties_av1),
	.dec_output_prop_avc = kera_vdec_output_properties_avc,
	.dec_output_prop_hevc = kera_vdec_output_properties_hevc,
	.dec_output_prop_vp9 = kera_vdec_output_properties_vp9,
	.dec_output_prop_av1 = kera_vdec_output_properties_av1,
	.dec_output_prop_size_avc = ARRAY_SIZE(kera_vdec_output_properties_avc),
	.dec_output_prop_size_hevc = ARRAY_SIZE(kera_vdec_output_properties_hevc),
	.dec_output_prop_size_vp9 = ARRAY_SIZE(kera_vdec_output_properties_vp9),
	.dec_output_prop_size_av1 = ARRAY_SIZE(kera_vdec_output_properties_av1),

	.msm_vidc_ssr_type = kera_msm_vidc_ssr_type,
	.msm_vidc_ssr_type_size = ARRAY_SIZE(kera_msm_vidc_ssr_type),

	/* Fuse specific resources */
	.efuse_data = efuse_data_kera,
	.efuse_data_size = ARRAY_SIZE(efuse_data_kera),
	.sku_version = SKU_VERSION_0,
};

static const struct msm_vidc_platform_data kera_data_v1 = {
	/* resources dependent on other module */
	.bw_tbl = kera_bw_table,
	.bw_tbl_size = ARRAY_SIZE(kera_bw_table),
	.pd_tbl = kera_pd_table,
	...
	/* platform specific resources */
	.freq_tbl = kera_freq_table_sku1,
	.freq_tbl_size = ARRAY_SIZE(kera_freq_table_sku1),
	.reg_prst_tbl = kera_reg_preset_table,
	.reg_prst_tbl_size = ARRAY_SIZE(kera_reg_preset_table),
	.dev_reg_tbl = kera_device_region_table,
	.dev_reg_tbl_size = ARRAY_SIZE(kera_device_region_table),
	...
	/* caps related resorces */
	.core_data = core_data_kera_v1,
	.core_data_size = ARRAY_SIZE(core_data_kera_v1),
	.inst_cap_data = instance_cap_data_kera_v1,
	.inst_cap_data_size = ARRAY_SIZE(instance_cap_data_kera_v1),
	.inst_cap_dependency_data = instance_cap_dependency_data_kera,
	.inst_cap_dependency_data_size = ARRAY_SIZE(instance_cap_dependency_data_kera),
	.csc_data.vpe_csc_custom_bias_coeff = vpe_csc_custom_bias_coeff,
	.csc_data.vpe_csc_custom_matrix_coeff = vpe_csc_custom_matrix_coeff,
...
static int msm_vidc_init_data(struct msm_vidc_core *core)
{
	...
	core->platform->data = kera_data_v0;
